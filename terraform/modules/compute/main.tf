...
resource "openstack_compute_instance_v2" "test-instance" {
  ...
  cr_instance_names  = flatten([for _ in range(1, 4) : [for i in range(1, 4) : format("labcr%02dcn", i)]])
  cm_instance_names  = flatten([for _ in range(1, 4) : [for i in range(1, 4) : format("labcm%02dcn", i)]])
  st_instance_names  = flatten([for _ in range(1, 4) : [for i in range(1, 4) : format("labst%02dcn", i)]])
