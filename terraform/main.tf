...
#}
locals {
  instances_with_floatip = {for f_instance_name, floating_ip_value in zip(module.compute.instance_id,module.floating_ips.float_ip) : module.compute.instances_names[f_instance_name] => floating_ip_value}
